...
# Updates for v1.0.1, jamesc@icr.ac.uk: 
# changed location of ccodeFile at line 47;
# commented 787+788 (fq comment match check);
# re-wrote 792+793 (regex updated for new format to find the lane info);
# commented all occurrences of 'unlink' for debugging
#  - this version is now in shalign.pl~ and the unlinks have been restored here for testing without the --dbload option...
